...
public final class RedisUtil {
	...
	// Redis服务器IP dalian
	private static String ADDR = "172.16.31.22";
	//private static String ADDR = "172.16.140.134";
	//private static String ADDR = "192.168.99.205";
	// Redis服务器IP IDC
	// private static String ADDR = "192.168.99.205";
	private static int DATABASE=10;
	// Redis的端口号
	private static int PORT = 6379;
	// 访问密码
	private static String AUTH = "senyint";
	// 可用连接实例的最大数目，默认值为8；
	...
	public static JedisPool getPool() {
		if (pool == null) {
			...
			pool = new JedisPool(config, ADDR, PORT,0,AUTH,DATABASE);
	 ...
	 * @return
	 */
	public static boolean setByte(String key, byte[] value, int time) {
		boolean is = false;
		try {
			JedisPool pool = null;
			Jedis jedis = null;
    ...
    public static void main(String[] args) {
		RedisUtil.set("11111", "YYYYYYYYYYYYYYYYYYY");
		System.out.println(RedisUtil.get("11111"));
	}
}